                ...
                using (DrawingContext dc = this.drawingGroup.Open())
                {
                    ...
                    foreach (Body body in bodies)
                    {
                        ...
                        if (body.IsTracked)
                        {
                            ...
                            /// 
                            /// 
                            /// Disgusting hack since my kinect is not working
                            /// 
                            /// Left Hand lasso Right Hand closed for Play
                            ///
                            /// 
                            /// Right Hand lasso Right Hand closed for Pause
                            /// 
                            /// 
                            ///
                            ...
                            /////////////////////////////////////////////////////////////////////////////////////////////////////
                            int x;
                            if (body.HandLeftState == HandState.Lasso && body.HandRightState == HandState.Closed)
                            {
                                DateTime Tthen = DateTime.Now;
                                do
                                {
                                    //Do something to do nothing
                                    x = 1;
